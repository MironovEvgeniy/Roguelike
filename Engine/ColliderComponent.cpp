...
{
    onCollisionActions.erase(std::remove_if(onCollisionActions.begin(),
...
{
    onTriggerEnterActions.erase(std::remove_if(onTriggerEnterActions.begin(),
...
{
    onTriggerExitActions.erase(std::remove_if(onTriggerExitActions.begin(),
